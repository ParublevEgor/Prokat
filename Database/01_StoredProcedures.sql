-- Выполнить в БД «Прокат» после SchemaUpdate / миграции (таблица Аренда_бронирование и колонки счёта).
...
BEGIN
    SET NOCOUNT ON;
    SET DATEFIRST 1; -- понедельник = 1, суббота = 6, воскресенье = 7
    ...
    IF DATEPART(WEEKDAY, @Начало) IN (6, 7) -- суббота, воскресенье
